package com.zipfian.beepi.project;// import org.apache.solr.client.solrj.SolrQuery;
...
public class JeepGrandCherokeeServlet extends HttpServlet {
    ...
    public final static String urlString = "http://localhost:8983/solr/review2";
    ...
    private void doSolrQuery(java.io.PrintWriter out) {
        if(solr == null)
